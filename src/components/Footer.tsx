  ...
  return (
    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <p>Email: <a href="sadiakham985@gmail.com" className="hover:text-yellow-500">duahussain569@gmail.com</a></p>
    ...
    <div className="border-t border-gray-700 mt-8 pt-6 text-center">
      ...
      <p>&copy; 2024 Dua Hussain. All rights reserved.</p>
      <div className="  flex justify-center items-center">
            <ul className="flex space-x-4 pt-5">
                <li>
                    <Link href="https://github.com/Dua456" target="_blank" rel="noopener noreferrer" className="text-white text-center hover:text-[#E1aD01]">
                        <FaGithub  size="30" /></Link>
                </li>
                <li>
                    <Link href="mailto:duahussain569@gmail.com" className="text-white text-center hover:text-[#E1aD01]">
                        <MdEmail size="30" />
                    </Link>
                </li>
                <li>
                  <Link href="https://www.linkedin.com/in/dua-shakir-0692b82b9/" target="_blank" rel="noopener noreferrer" className="text-white text-center hover:text-[#E1aD01]">
                      <FaLinkedin size="30" />
                  </Link>
              </li>
            </ul>
